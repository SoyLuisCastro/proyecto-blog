...
<aside id="sidebar">
    ...
    <div id="buscador" class="bloque">
        ...
        <form action="buscar.php" method="POST">
            <input type="text" name="busqueda"placeholder="busqueda......" required="required">
    ...
    <div id ="login" class="bloque"> 
        ...
        <form action="login.php" method="POST">
            ...
            <input type="email" name="email"placeholder="ingrese el email" required="required">
            <label for="password">Contraseña</label>
            <input type="password" name="password"placeholder="ingrese password" required="required">
